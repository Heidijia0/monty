...
#include <ctype.h>
/**
 * struct stack_s - doubly linked representation of stack (or queue)
 * @n: integer
 ...
 * Description: carries values the program
 */
typdef struct bus_s
{
	char *arg;
 ...
 * for stack, queue-LIFO, FIFO Holberton school project
 */
...
int execute(char *content, stack **head, unsigned int counter);
...
void _mull(stack_t **head, unsigned int counter);
...
void addnode(stack_t **head, unsigned int counter);
